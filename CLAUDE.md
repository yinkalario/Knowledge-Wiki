# Claude Code Adapter — Knowledge_Wiki

This file is a thin entrypoint for Claude Code. The authoritative, vendor-neutral protocol lives in `_system/`.
...
- Do not depend on Claude Code conversation history, memory, hooks, cache, embeddings, or files outside the Vault.
